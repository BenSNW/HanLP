...
/**
 * TextRankKeywords 自动摘要
 *
 * @author hankcs
 */
public class TextRankSummation
{
    /**
    ...
    public TextRankSummation(List<List<String>> docs)
    {
        this.docs = docs;
        bm25 = new BM25(docs);
        D = docs.size();
...
//            System.out.println(Arrays.toString(scores));
    ...
    public static List<String> getTopSentenceList(String document, int size)
    {
        ...
        TextRankSummation textRank = new TextRankSummation(docs);
