 ...
 * </copyright>
 */
package com.hankcs.hanlp.dep.nnparser;

import com.hankcs.hanlp.corpus.dependency.CoNll.CoNLLSentence;
import com.hankcs.hanlp.corpus.dependency.CoNll.CoNLLWord;
import com.hankcs.hanlp.dep.AbstractDependencyParser;
import com.hankcs.hanlp.dep.nnparser.option.ConfigOption;
import com.hankcs.hanlp.seg.common.Term;
import com.hankcs.hanlp.util.PosTagUtil;
...
public class NeuralNetworkDependencyParser extends AbstractDependencyParser
{
    ...
    public CoNLLSentence parse(List<Term> termList)
    {
        ...
        {
            wordArray[i] = new CoNLLWord(i + 1, wordList.get(i), posTagList.get(i), termList.get(i).tag.toString());
